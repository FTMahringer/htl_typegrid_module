...
/**
 * Erstellt ein Formular zum Auswählen von Attributen für das Grid.
 *
...
final class FieldPickerForm extends FormBase
{
  ...
  public function buildForm(
    ...
    $options = [];
    if ($bundle !== "") {
      $defs = \Drupal::service("entity_field.manager")->getFieldDefinitions(
        "node",
        $bundle,
      );
    ...
    $form["options"] = [
      ...
      "#required" => false,
      "#description" => $this->t(
        "Wähle bis zu drei Felder, die unter dem Titel angezeigt werden.",
      ),
    ];
  ...
  public function validateForm(
    ...
    if (count($picked) > 3) {
      $form_state->setErrorByName(
        "options",
        $this->t("Bitte maximal 3 Felder auswählen."),
      );
    }
  }
  ...
  public function ajaxSubmit(
    ...
    $referer =
      \Drupal::request()->headers->get("referer") ?: "/admin/structure/block";
